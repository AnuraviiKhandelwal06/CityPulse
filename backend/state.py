...
def get_active_alert(step: Optional[int] = None) -> Optional[DisruptionEvent]:
    ...
    return DisruptionEvent(
        ...
        is_ai_generated=summary_obj.get("is_ai_generated", False),
        ai_status_message=summary_obj.get("ai_status_message", None),
...
def get_step_zones(step: Optional[int] = None) -> List[ZoneStatus]:
    ...
    return [
        ...
        ZoneStatus(
            ...
            severity_score=0.48,
            confidence=0.86,
            summary="Market Corridor • Traffic 58% • Rain 14.5 mm/h",
            speed="30 km/h",
            rain="14.5 mm/h",
            reports=1,
            transit_delay=6,
        ...
        ZoneStatus(
            ...
            severity_score=0.15,
            confidence=0.92,
            summary="Free Flow • Normal conditions",
            speed="45 km/h",
            rain="1.5 mm/h",
            reports=0,
            transit_delay=1,
        ...
        ZoneStatus(
            ...
            severity_score=0.18,
            confidence=0.90,
            summary="Commercial Ring Road • Free flow (18%) • Rain 1.0 mm/h",
            speed="42 km/h",
            rain="1.0 mm/h",
            reports=0,
            transit_delay=2,
